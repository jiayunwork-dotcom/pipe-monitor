...
func AutoMigrate(db *gorm.DB) error {
	...
	fkDefinitions := []struct {
		...
		{"alert_escalations", "fk_alert_esc_alert", "alert_id", "alert_events", "id", "CASCADE"},
		{"alert_escalations", "fk_alert_esc_trigger", "triggered_by_id", "users", "id", "SET NULL"},
		{"on_call_groups", "fk_occ_group_leader", "leader_id", "users", "id", "SET NULL"},
